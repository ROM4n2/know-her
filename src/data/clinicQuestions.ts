...
export const RED_FLAG_SYMPTOMS: RedFlagItem[] = [
  {
    ...
    emergencyAlert:
      '【急诊红旗预警】可能提示宫外孕破裂、黄体破裂、急性盆腔脓肿破裂或卵巢囊肿蒂扭转，属于危急妇科急腹症，不可等待常规预约门诊，请立即前往最近公立医院急诊！',
  },
  {
    id: 'syncope_shock',
    label: '突发面色苍白/冷汗或晕厥',
    ...
    emergencyAlert:
      '【急诊红旗预警】高度提示腹腔内大出血或失血性休克！请立即平卧保持呼吸道通畅，并由同伴呼叫 120 急救！',
  },
  {
    id: 'heavy_hemorrhage',
    ...
    emergencyAlert:
      '【急诊红旗预警】属于急性活动性重度大出血，极易在短时间内导致失血性贫血与循环衰竭，必须即刻送往医院急诊科止血！',
  },
  {
    ...
    emergencyAlert:
      '【急诊红旗预警】警惕急性盆腔腹膜炎、输卵管卵巢脓肿（TOA）或全身脓毒症感染，需要急诊化验血常规并启动静脉强效抗生素治疗！',
  },
];
